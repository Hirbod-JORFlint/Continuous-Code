...
HANDOFF_DIR="$OPC_PROJECT_DIR/thoughts/shared/handoffs"
...
Write checkpoints to the handoff file at `$OPC_PROJECT_DIR/thoughts/shared/handoffs/<task-name>/current.md`:
...
HANDOFF_DIR="$OPC_PROJECT_DIR/thoughts/shared/handoffs/kraken-$(date +%Y%m%d)"
mkdir -p "$HANDOFF_DIR"
