...
```
The agent wants to Read file.py
         |
         v
+-------------------+
...
```
The agent calls Grep("validateToken")
         |
         v
+-------------------+
