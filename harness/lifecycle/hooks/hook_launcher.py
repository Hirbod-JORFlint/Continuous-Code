...
def get_hooks_dirs() -> list[Path]:
    """Get the neutral hooks directories, search order:
    ...
    # Canonical neutral hooks dir (this launcher lives there)
        ...
        if uv_path:
            ...
            if not python_path:
                return {
                    "returncode": 1,
                    "stdout": "",
                    "stderr": "Error: Neither uv nor Python found. "
                    "Please install uv (recommended) or Python 3.",
                }
