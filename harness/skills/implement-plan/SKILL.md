...
2. **Read the implementation agent skill:**
   ```bash
   cat harness/skills/implement-task/SKILL.md
   ```
...
2. **Spawn implementation agent:**
   ...
   Task(
     ...
     prompt="""
     [Paste contents of harness/skills/implement-task/SKILL.md here]
...
âœ… Task 1 complete. Handoff: thoughts/handoffs/add-auth/task-01-user-model.md
...
âœ… Task 2 complete. Handoff: thoughts/handoffs/add-auth/task-02-auth-middleware.md
